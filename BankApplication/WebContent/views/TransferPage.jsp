...
<tr>&nbsp;</tr>
<tr>
<td><font size="5">Target Account Number:</font></td>
<td><input type="text" name="targetAccountNo" placeholder="Target Account Number" style="height: 20px; width: 175px;" required></td>
</tr>
<tr>&nbsp;</tr>
